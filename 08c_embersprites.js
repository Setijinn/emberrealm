...
const ASC_FORMS=['templar','warlord','sentinel','crusader','guardian','highpriest','ravager','bloodlord','juggernaut','wyrmknight','skylord','dragonlord','deathblade','nightblade','reaper','nightshade','executioner_a','phantom_a'];   // grows as each form's art lands
