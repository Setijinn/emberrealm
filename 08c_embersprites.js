...
const ASC_FORMS=['templar','warlord','sentinel','crusader','guardian','highpriest','ravager','bloodlord','juggernaut','wyrmknight','skylord','dragonlord','deathblade','nightblade','reaper','nightshade','executioner_a','phantom_a','sharpshooter','windranger','tempest_r','packlord','falconer','pathwarden','maestro','skald','loremaster','grandmaster','windwalker','ascendant','bishop','inquisitor','warden_c','infernomancer','emberlord','cinderguard'];   // grows as each form's art lands
