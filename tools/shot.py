...
USAGE
    ...
    py tools/shot.py 0                     # one territory by index
    py tools/shot.py all                   # every territory, into shots/
"""
...
def build():
    ...
    inject = (
        ...
        '<script defer src="_shot.js"></script>\n'
    )
...
def shoot(idx, hud=False):
    ...
    cmd = [
        ...
        "--user-data-dir=" + os.path.join(tempfile.gettempdir(), "emberrealm_shot_profile"),
